                    ...
                    <a href="/" class="inline-block">
                        <div class="flex items-center gap-4">
                            <div class="w-20 h-20 bg-white rounded-xl flex items-center justify-center shadow-lg">
                                <img src="{{ asset('images/logo-himpaudi.png') }}" alt="Logo HIMPAUDI" class="w-16 h-16 object-contain">
                            </div>
                            <div class="text-white">
                                <h1 class="text-4xl font-bold">HIMPAUDI</h1>
                                <p class="text-blue-200 text-lg">Bekasi Timur</p>
                            </div>
                        </div>
                    </a>
                </div>
