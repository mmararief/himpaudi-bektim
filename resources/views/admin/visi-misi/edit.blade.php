        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <h2 class="text-2xl font-bold text-gray-800">Edit Visi & Misi</h2>
                </div>
                <p class="text-gray-600 ml-9">Perbarui konten visi dan misi organisasi</p>
            </div>

            <!-- Form Card -->
            <div class="bg-white rounded-lg shadow">
                <form action="{{ route('admin.visi-misi.update', $visiMisi->id) }}" method="POST" class="p-6 space-y-6">
                    @csrf
                    @method('PUT')
