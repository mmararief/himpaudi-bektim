    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-600 ml-9">Tambahkan pertanyaan yang sering ditanyakan</p>
            </div>

            <!-- Form Card -->
            <div class="bg-white rounded-lg shadow">
                <form action="{{ route('admin.faq.store') }}" method="POST" class="p-6 space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">FAQ akan ditampilkan berdasarkan urutan dari yang terkecil. Urutan berikutnya: {{ $maxUrutan }}</p>
                    </div>
